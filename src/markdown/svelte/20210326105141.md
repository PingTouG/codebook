...
{#if status}
	<h1 transition:fly="{{delay: 250, duration: 300, x: 100, y: 100, opacity: 0.5, easing: quintOut}}">Hello</h1>
{/if}
```
...
{#if status}
	<h1 transition:scale="{{duration: 500, delay: 500, opacity: 0.5, start: 0.3, easing: quintOut}}">Hello</h1>
{/if}
```
...
<svg viewBox="0 0 5 5" xmlns="http://www.w3.org/2000/svg">
	{#if status}
		<path transition:draw="{{duration: 5000, easing: quintOut}}"
