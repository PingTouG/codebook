...
var SvelteComponentDev = /*#__PURE__*/function (_SvelteComponent) {
  ...
  var _super2 = _createSuper$3(SvelteComponentDev);
...
var file = "src\\routes\\_error.svelte"; // (11:2) {#if status === 404}
...
function create_if_block_1$1(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      if (img.src !== (img_src_value = "/assets/images/404.png")) attr_dev(img, "src", img_src_value);
      attr_dev(img, "alt", img_alt_value =
      /*error*/
      ctx[1].message);
      add_location(img, file, 11, 4, 233);
    },
    m: function mount(target, anchor) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(11:2) {#if status === 404}",
    ctx: ctx
  });
  return block;
} // (20:2) {#if dev && error.stack}
...
function create_if_block$1(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      add_location(pre, file, 20, 4, 401);
    },
    m: function mount(target, anchor) {
  ...
  dispatch_dev("SvelteRegisterBlock", {
    ...
    type: "if",
    source: "(20:2) {#if dev && error.stack}",
    ctx: ctx
  });
  return block;
}
...
function create_fragment$1(ctx) {
  ...
  var block = {
    ...
    l: function claim(nodes) {
      var head_nodes = query_selector_all("[data-svelte=\"svelte-69nivd\"]", document.head);
